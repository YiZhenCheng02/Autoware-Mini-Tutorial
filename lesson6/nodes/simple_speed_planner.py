...
class SimpleSpeedPlanner:
    ...
    def collision_points_and_path_callback(self, collision_points_msg, local_path_msg):
        try:
            ...
            target_distances = collision_point_distances - self.distance_to_car_front - collision_point_braking_distances
            ...
            stopping_point_distance = collision_point_distances[min_idx] - collision_point_braking_distances[min_idx]
